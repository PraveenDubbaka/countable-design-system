...
export function EngagementRightPanel({ className }: EngagementRightPanelProps) {
  ...
  return (
    <div className={cn("flex h-full", className)}>
      ...
      <div className="w-12 bg-[#FDFDFF] dark:bg-muted border-l border-border flex flex-col items-center py-3 gap-1">
        {/* Toggle Button */}
        <Button
          variant="ghost"
          size="icon"
      ...
      <div
        className={cn(
          "bg-[#FDFDFF] dark:bg-muted border-l border-border transition-all duration-300 overflow-hidden",
          isExpanded ? "w-72" : "w-0"
        )}
      >
        {isExpanded && (
