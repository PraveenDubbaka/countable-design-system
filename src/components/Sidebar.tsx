                ...
                const auditEngagementTree: SectionNode[] = [
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { id: "aud-ra-510", code: "510", label: "Identifying Risks through Understanding the Entity", icon: "worksheet", route: "checklist/aud-ra-510" },
                      { id: "aud-ra-511", code: "511", label: "Understanding the IT Environment", icon: "worksheet", route: "checklist/aud-ra-511" },
                      ...
                      >
                        ...
                        {((nodeDocuments[node.id]?.length ?? 0) > 0 || notesPages.has(node.id)) && (
                          <button
                            ...
                            style={{ left: `${depth * 16 - 11}px`, width: '14px', height: '14px', top: '50%', transform: 'translateY(-50%)' }}
                            onClick={e => {
                              e.stopPropagation();
