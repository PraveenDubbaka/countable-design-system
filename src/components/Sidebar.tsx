                ...
                const usAuditEngagementTree: SectionNode[] = [
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { id: "aud-us-asm", code: "OAS", label: "Overall Audit Strategy", icon: "worksheet", route: "checklist/aud-us-asm" },
                ...
                const auditEngagementTree: SectionNode[] = [
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { id: "aud-asm", code: "OAS", label: "Overall Audit Strategy", icon: "worksheet", route: "checklist/aud-asm" },
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { id: "aud-ra-511", code: "ITE", label: "Understanding the IT Environment", icon: "worksheet", route: "checklist/aud-ra-511" },
                      ...
                      { id: "aud-ra-540", code: "CDI", label: "Control Design / Implementation", icon: "worksheet", route: "checklist/aud-ra-540" },
                      { id: "aud-ra-550", code: "CAD", label: "Control Activities — Design, Implementation and Control Risk", icon: "checklist", route: "checklist/aud-ra-550" },
                      { id: "aud-ra-551", code: "GIC", label: "Understanding General IT Controls — Design and Implementation", icon: "checklist", route: "checklist/aud-ra-551" },
                      { id: "aud-ra-575", code: "ICD", label: "Internal Control Deficiencies Identified", icon: "worksheet", route: "checklist/aud-ra-575" },
                      { id: "aud-ra-580", code: "SDC", label: "Communication of Significant Deficiencies in Internal Control", icon: "checklist", route: "checklist/aud-ra-580" },
                      { id: "aud-ra-590", code: "ESC", label: "Engagement Scoping — Classes of Transactions, Account Balances and Disclosures", icon: "worksheet", route: "checklist/aud-ra-590" },
                    ]
                  },
                  {
