  ...
  return (
    <div className="flex h-screen relative">
      ...
      {location.pathname.startsWith("/engagements/") && location.pathname !== "/engagements/create" && (
        <>
          <div
            className={`flex flex-col rounded-tr-[20px] rounded-br-[20px] relative z-40 transition-all duration-300 group/templates ${isTemplatesPanelCollapsed ? "w-0 overflow-hidden shadow-none bg-transparent" : "w-[300px] shadow-md bg-[#f5f8fa]"}`}
          >
