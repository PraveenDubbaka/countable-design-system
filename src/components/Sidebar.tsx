                ...
                const auditEngagementTree: SectionNode[] = [
                  ...
                  },
                  {
                    ...
                    children: [
                      ...
                      { id: "aud-ra-510", code: "510", label: "Identifying Risks through Understanding the Entity", icon: "checklist", route: "checklist/aud-ra-510" },
                      { id: "aud-ra-511", code: "511", label: "Understanding the IT Environment", icon: "checklist", route: "checklist/aud-ra-511" },
                      { id: "aud-ra-513", code: "513", label: "Understanding Accounting Estimates and Related Disclosures", icon: "checklist", route: "checklist/aud-ra-513" },
                      ...
                      { id: "aud-ra-520", code: "520", label: "Risk Register — Entity Specific — Business / Operating", icon: "worksheet", route: "checklist/aud-ra-520" },
