...
const COMPILATION_SECTIONS: TemplateSection[] = [
  {
    ...
    hasAddSection: true,
    rows: [
      { name: "Client acceptance and continuance", category: "Checklists", categoryColor: "checklist", categoryBg: "checklist", categoryIcon: "checklist", mappedTemplate: "Client Acceptance & Continuance CSRS 4200" },
      { name: "Independence", category: "Checklists", categoryColor: "checklist", categoryBg: "checklist", categoryIcon: "checklist", mappedTemplate: "Independence CSRS 4200" },
      ...
      { name: "Planning", category: "Checklists", categoryColor: "checklist", categoryBg: "checklist", categoryIcon: "checklist", mappedTemplate: "Planning CSRS 4200" },
      { name: "Engagement Letter", category: "Letters", categoryColor: "letter", categoryBg: "letter", categoryIcon: "letter", mappedTemplate: "Engagement compilation CSRS 4200" },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: "Cover Page", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Compilation template" },
      { name: "Table of Contents", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Compilation template" },
      { name: "Compilation Report", category: "Reports", categoryColor: "report", categoryBg: "report", categoryIcon: "report", mappedTemplate: "Compilation Report Section 4200" },
      { name: "Balance Sheet", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Compilation template" },
      { name: "Statement of Income (Loss) and Retained Earnings (Deficit)", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Compilation template" },
      { name: "Notes to Financial Statements", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Compilation template" },
    ],
  },
  {
    ...
    hasAddSection: true,
    rows: [
      { name: "Completion Checklist", category: "Checklists", categoryColor: "checklist", categoryBg: "checklist", categoryIcon: "checklist", mappedTemplate: "Completion Section 4200" },
      { name: "Partner/Manager Review", category: "Checklists", categoryColor: "checklist", categoryBg: "checklist", categoryIcon: "checklist", mappedTemplate: "Review sign-off Section 4200" },
    ],
  },
];
...
const REVIEW_SECTIONS: TemplateSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { name: "Cover Page", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Review template" },
      { name: "Table of Contents", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Review template" },
      ...
      { name: "Balance Sheet", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Review template" },
      { name: "Statement of Income (Loss) and Retained Earnings (Deficit)", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Review template" },
      { name: "Statement of Cash Flows", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Review template" },
      { name: "Notes to Financial Statements", category: "Financial Statements", categoryColor: "fs", categoryBg: "fs", categoryIcon: "fs", mappedTemplate: "Review template" },
    ],
  },
  {
    title: "Completion & Signoffs",
    ...
    rows: [
      ...
      { name: "Management representation letter", category: "Letters", categoryColor: "letter", categoryBg: "letter", categoryIcon: "letter", mappedTemplate: "Management representation Section 2400" },
      ...
      { name: "Disclosure", category: "Checklists", categoryColor: "checklist", categoryBg: "checklist", categoryIcon: "checklist", mappedTemplate: "ASPE - General - Disclosure checklist" },
