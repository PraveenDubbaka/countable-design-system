...
export function PBCRequestFlow({
 ...
 useEffect(() => {
  if (!demoAutoStart) return;
  const demoContent = `# Audit Request List — Northline Precision Manufacturing Inc.
**Period:** January 1 – December 31, 2025
**Prepared by:** Luka (AI) · ${new Date().toLocaleDateString('en-CA')}

---

## Section A — Entity & Governance
1. Signed copy of the 2025 engagement letter
2. Articles of incorporation and any amendments since Dec 31, 2024
3. Shareholder register and any share transfers in 2025
4. Minutes of directors' and shareholders' meetings for the year
5. Any management representation letter template used by prior accountants

## Section B — Financial Information
6. Draft financial statements (income statement, balance sheet, statement of retained earnings) for Dec 31, 2025
7. Trial balance as at December 31, 2025 — agreed to general ledger
8. Bank statements and bank reconciliations for all accounts — December 31, 2025
9. Accounts receivable aged listing as at December 31, 2025
10. Accounts payable subledger and aged listing as at December 31, 2025
11. Inventory count sheets and costing schedule — December 31, 2025
12. Fixed asset continuity schedule for the year (additions, disposals, depreciation)

## Section C — Revenue & Contracts
13. Top 10 customer contracts or purchase orders — active in 2025
14. Revenue recognition policy documentation for manufactured goods
15. Shipping logs and delivery confirmations for Q4 2025 (cut-off testing)
16. Any bill-and-hold or consignment arrangements

## Section D — Debt & Related Parties
17. Term loan agreement with current balance confirmation (covenant compliance schedule)
18. List of all related parties and summary of transactions with Northline Holdings Inc.
19. Lease agreements — Mississauga plant and Barrie warehouse
20. Any guarantees provided or received during 2025

## Section E — Taxes & Compliance
21. Prior year T2 corporate tax return (CCPC — review engagement basis)
22. HST returns filed for 2025 and any outstanding correspondence with CRA
23. Payroll remittance summaries and T4 summary for 2025

________________________________________________________________________________
*Generated by Luka from Xero chart of accounts, prior-year review file, and entity profile.*`;
  setTimeout(() => {
   setSelectedTemplate(PBC_TEMPLATES[0]);
   setDocContent(demoContent);
   setMessages([{
    role: 'luka',
    text: `I've generated an initial request list for **${clientName}** based on your Xero connection, prior-year file, and entity profile. Review and send when ready.`,
    isArtifact: true,
   }]);
   setPhase('artifact');
  }, 600);
