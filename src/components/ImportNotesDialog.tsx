...
const DEMO_RESULT: Omit<ImportResult, "source"> = {
  ...
  agendaNotes: {
    ...
    a5: "Preliminary AR shows revenue +12%, GM down 3pts vs prior year — to be investigated on Form 520. Inventory turnover lower than prior year.",
    ...
    b8: "All RMMs carried to Form 520. F/S level risk: management override (significant). Assertion-level: revenue cut-off (significant), inventory existence (significant).",
    b9: "Reviewed Form 506. Discussed pressure from lender covenant as fraud risk factor. No known attitudes of override but planned JE testing expanded.",
    ...
    b12: "Reminded team on professional skepticism, ongoing communication, and Form 430 updates if scope changes.",
