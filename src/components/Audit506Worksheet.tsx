...
...def,...saved,
 ...
 To document inquiries about fraud risks performed as part of the risk assessment. <span className="font-medium text-foreground">Part A</span> covers required inquiries of management, others in the entity, and TCWG. <span className="font-medium text-foreground">Part B</span> covers other fraud risk assessment procedures.{" "}
