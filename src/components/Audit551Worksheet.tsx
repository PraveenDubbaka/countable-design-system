...
interface RafuitRow {
  id: string;
  automatedControl: string;        // ref / description from Form 550
  itLayer: ITLayer;
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
        ...
        <div className="bg-card border border-border shadow-[0_2px_8px_hsl(213_40%_20%/0.06)] rounded-md overflow-hidden">
          <div className="px-6 py-3.5 bg-card border-b border-border flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-[11px] text-muted-foreground mt-0.5">
                For each automated control identified on Form 550, document the IT layer, risk, related IT process,
            ...
            <table className="w-full text-xs">
              <thead className="sticky top-0 z-10">
                <tr className="bg-muted border-b border-border">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-semibold text-foreground uppercase tracking-wider" style={{ minWidth: 220 }}>Automated control (Form 550)</th>
        ...
        <div className="bg-primary/[0.03] border border-primary/15 rounded-md p-4 text-xs text-foreground/85 space-y-1.5">
          ...
          <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
            ...
            <li><b>Note 2:</b> Communicate significant deficiencies in writing to TCWG on a timely basis (Form 575). Implementation cannot be determined by inquiry alone.</li>
        ...
        <div className="bg-card border border-border rounded-md p-5 space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            and whether they support reliance on the automated controls documented on Form 550.
          </p>
