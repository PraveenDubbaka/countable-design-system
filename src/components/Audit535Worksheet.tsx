...
const PART_E: ProcItem[] = [
  { id: 'e12', num: '12', title: 'Reassess identified risks', intro: 'Based on the understanding obtained, consider:', items: [
    'Whether the risks identified and assessed on Form 520 are still appropriate.',
    'Whether any new risks were identified.',
  ]},
  { id: 'e13', num: '13', title: 'Identify controls to test', intro: 'Document controls identified that address risks of material misstatement at the assertion level on Form 550 (D&I) that meet the following criteria:', items: [
  ...
  { id: 'e15', num: '15', title: 'Communicate deficiencies', intro: 'Where significant control deficiencies have been identified, ensure they are communicated in writing to TCWG on a timely basis (Form 575).' },
];
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-5">
              ...
              <div key={s.id} className="p-5 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="col-span-2 space-y-1">
                    <label className="text-xs font-medium text-muted-foreground">If No — significant deficiencies &amp; audit response (Form 575)</label>
        ...
        <div className="bg-card border border-border rounded-md p-5 space-y-3">
          ...
          <div className="space-y-1">
            <label className="text-xs font-medium text-muted-foreground">New risks identified (carry forward to Form 520)</label>
          ...
          <div className="space-y-1">
            <label className="text-xs font-medium text-muted-foreground">Controls identified for D&amp;I testing (Form 550)</label>
          ...
          <div className="space-y-1">
            <label className="text-xs font-medium text-muted-foreground">Significant deficiencies communicated to TCWG (Form 575)</label>
