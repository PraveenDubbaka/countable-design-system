    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-2.5 border-b border-border bg-primary/[0.03] flex items-start gap-2 shrink-0">
        ...
        <p className="text-xs text-muted-foreground flex-1 leading-relaxed">
          ...
          <span className="font-medium text-foreground">Part C</span> to record relevant extracts. Record risk factors on{" "}
          <span className="font-medium text-foreground">Form 520</span>.
        </p>
      </div>
              ...
              <table className="w-full">
                <thead className="sticky top-0 z-10">
                  <tr className="bg-muted border-b border-border">
                    ...
                    <th className="w-[110px] px-4 py-3 text-center text-xs font-semibold text-foreground uppercase tracking-wider border-l border-border" style={{ minWidth: 110 }}>Record on Form 520</th>
