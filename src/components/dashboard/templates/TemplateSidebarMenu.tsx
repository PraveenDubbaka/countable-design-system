...
export const makeEntityTemplates = (prefix: string, codePrefix: string): MenuItem[] => [
...
export const makeCanadaEntityTemplates = (prefix: string, codePrefix: string): MenuItem[] => [
 { code: `${codePrefix}COMP`, label: "Compilations", type: "folder", children: [
...
export const myTemplatesByEntity: Record<string, MenuItem[]> = {
...
export const myCanadaTemplatesByEntity: Record<string, MenuItem[]> = {
...
export const globalTemplatesByEntity: Record<string, MenuItem[]> = {
...
export const RecursiveMenuItem = ({ item, expandedFolders, toggleFolder, selectedItem, onSelectItem, depth, searchQuery, publishedItems }: RecursiveMenuItemProps) => {
...
export const US_ENTITY_TYPES = ["C-Corp", "S-Corp", "Partnership", "LLC (Single Member)", "LLC (Multiple Members)", "Sole Proprietorship", "Trust"];
export const CA_ENTITY_TYPES = ["Corporations", "Partnership", "LLC (Single Member)", "LLC (Multiple Members)", "Sole Proprietorship", "Trust"];
