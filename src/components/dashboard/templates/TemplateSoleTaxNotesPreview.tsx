...
const TemplateSoleTaxNotesPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
 ...
 <p style={{ fontSize: baseFontSize * 0.9, marginBottom: 8 }}>
 The business is a sole proprietorship operating in [Province/Territory], Canada. The proprietor reports business income (Statement of Business or Professional Activities) as part of the personal income tax return (T1).
 </p>
 ...
 <p style={{ fontSize: baseFontSize * 0.9, marginBottom: 8 }}>
 Interest paid on business loans is deductible against business income
 </p>
 ...
 <p style={{ fontSize: baseFontSize * 0.9, marginBottom: 8 }}>
 As a sole proprietorship, business income is reported on the proprietor's personal T1 return and is subject to tax at the individual's marginal rate. The net business income of $27,100 (prior year — $17,000) is reported and is subject to both income tax and Canada Pension Plan (CPP) self-employment contributions.
 </p>
