    ...
    auditProcedures: [
      ...
      },
      {
        ...
        rows: [
          ...
          mkRow("Optional",  "",              "Risk-specific procedures — Insert procedures as required."),
          mkRow("Optional",  "",              "Substantive analytical procedures — Insert procedures as required."),
          mkRow("Optional",  "Inspection",    "Sampling procedures — Tests of details (Form 610): Select a sample of accounts receivable invoices. Review the invoice date, balance, etc., and calculate the number of days the invoice is outstanding since the period end. Ensure the classification of the invoice on the aging is appropriate and the invoice details match what is on the listing."),
          mkRow("Optional",  "Inspection",    "Sampling procedures — Tests of controls (Form 615): Select a sample of _______ and ensure ________."),
        ],
      },
      {
        ...
        rows: [
          ...
          mkRow("Optional",  "",           "Risk-specific procedures — Insert procedures as required."),
          mkRow("Optional",  "",           "Substantive analytical procedures — Insert procedures as required."),
          mkRow("Optional",  "Inspection", "Sampling procedures — Tests of details (Form 610): Confirmations — Select a sample of accounts receivable for confirmation. Document how the sample was selected (i.e., level of assurance required) and how the items were selected (i.e., judgmental or using monetary unit sampling). Perform the procedures outlined in Form C.110."),
          mkRow("Optional",  "Inspection", "Sampling procedures — Tests of controls (Form 615): Select a sample of _______ and ensure _______."),
        ],
      },
      {
        title: "PRESENTATION",
