    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:bg-card focus-visible:border-primary focus-visible:border-2 focus-visible:px-[15px]",
          // Disabled state
          ...
          // Error state
          error && "bg-card border-destructive border-2 px-[15px] hover:border-destructive focus:border-destructive focus-visible:border-destructive",
          className,
        )}
        ref={ref}
        {...props}
    ...
    return (
      <input
        ...
        className={cn(
          ...
          "bg-muted border-b border-transparent text-foreground placeholder:text-muted-foreground",
          // Hover state: slightly different background
          "hover:bg-muted/80 hover:border-muted-foreground/50",
          // Focus state: primary bottom border
