  ...
  sections: [
    {
      name: "Client Onboarding",
      rows: [
        { section: "New engagement acceptance (CAS 220)", category: "checklist", mappedTemplate: "New engagement acceptance Section 5100" },
        { section: "Existing engagement continuance (CAS 220)", category: "checklist", mappedTemplate: "Existing engagement continuance Section 5100" },
        { section: "Independence & Ethical Requirements (CAS 220 / CSQC 1)", category: "checklist", mappedTemplate: "Independence Section 5100" },
        { section: "Engagement Letter (CAS 210)", category: "letter", mappedTemplate: "Audit engagement letter Section 5100" },
    ...
    },
    {
      name: "Planning",
      rows: [
        { section: "Understanding the Entity — Basics (CAS 315)", category: "checklist", mappedTemplate: "Understanding entity basics Section 5100" },
        { section: "Understanding the Entity — Systems & Controls (CAS 315)", category: "checklist", mappedTemplate: "Understanding entity systems Section 5100" },
        { section: "Understanding the Entity — Industry & Environment (CAS 315)", category: "checklist", mappedTemplate: "Industry environment Section 5100" },
        { section: "Materiality Calculation (CAS 320)", category: "worksheet", mappedTemplate: "Materiality Section 5100" },
        { section: "Engagement Scope (CAS 300)", category: "worksheet", mappedTemplate: "Engagement scope Section 5100" },
        { section: "Preliminary Analytical Procedures (CAS 520)", category: "worksheet", mappedTemplate: "Preliminary analytics Section 5100" },
        { section: "Audit Strategy Memorandum (CAS 300)", category: "checklist", mappedTemplate: "Audit strategy memo Section 5100" },
        { section: "Engagement Planning (CAS 300)", category: "checklist", mappedTemplate: "Engagement planning Section 5100" },
        { section: "Staffing & Time Budget", category: "worksheet", mappedTemplate: "Staffing and budget Section 5100" },
        { section: "Communication with Those Charged with Governance (CAS 260)", category: "letter", mappedTemplate: "TCWG planning communication Section 5100" },
      ],
    },
    {
      name: "Risk Assessment",
      rows: [
        { section: "Risk Assessment Procedures (CAS 315)", category: "checklist", mappedTemplate: "Risk assessment Section 5100" },
        { section: "Understanding Internal Controls (CAS 315)", category: "checklist", mappedTemplate: "Internal controls Section 5100" },
        { section: "IT General Controls — ITGC (CAS 315)", category: "checklist", mappedTemplate: "ITGC Section 5100" },
        { section: "Fraud Risk Assessment (CAS 240)", category: "checklist", mappedTemplate: "Fraud risk Section 5100" },
        { section: "Significant Risks Register (CAS 315)", category: "worksheet", mappedTemplate: "Significant risks worksheet Section 5100" },
        { section: "Risk of Material Misstatement — RMM (CAS 315)", category: "worksheet", mappedTemplate: "RMM worksheet Section 5100" },
        ...
        { section: "Going Concern — Initial Assessment (CAS 570)", category: "checklist", mappedTemplate: "Going concern Section 5100" },
      ],
    },
    {
      name: "Response to Assessed Risks",
      rows: [
        { section: "Overall Audit Response (CAS 330)", category: "checklist", mappedTemplate: "Overall response Section 5100" },
        { section: "Test of Controls (CAS 330)", category: "module", mappedTemplate: "Automated" },
        { section: "Substantive Analytical Procedures (CAS 520)", category: "worksheet", mappedTemplate: "SAP Section 5100" },
        { section: "Test of Details — Revenue (CAS 330)", category: "worksheet", mappedTemplate: "ToD revenue Section 5100" },
        { section: "Test of Details — Expenses (CAS 330)", category: "worksheet", mappedTemplate: "ToD expenses Section 5100" },
    ...
    },
    {
      ...
      rows: [
        { section: "Trial Balance & Adjusting Entries", category: "module", mappedTemplate: "Automated" },
        { section: "Audit Adjustments & Reclassifications (CAS 450)", category: "worksheet", mappedTemplate: "AJE worksheet Section 5100" },
      ],
    },
    {
      name: "Procedures",
      rows: [
        ...
        { section: "B — Accounts Receivable & Confirmations (CAS 505)", category: "worksheet", mappedTemplate: "AR Section 5100" },
        { section: "C — Inventory & Observation (CAS 501)", category: "worksheet", mappedTemplate: "Inventory Section 5100" },
        ...
        { section: "DD — Income Taxes & Deferred Tax (ASPE s.3465)", category: "worksheet", mappedTemplate: "Income taxes Section 5100" },
        ...
        { section: "GG — Related Party Transactions (CAS 550)", category: "worksheet", mappedTemplate: "RPT Section 5100" },
        { section: "700 — Revenue Testing (CAS 240 / CAS 330)", category: "worksheet", mappedTemplate: "Revenue Section 5100" },
    ...
    },
    {
      name: "Completion & Signoffs",
      rows: [
        { section: "Accumulation of Identified Misstatements — AIM (CAS 450)", category: "worksheet", mappedTemplate: "AIM Section 5100" },
        { section: "Final Analytical Review (CAS 520)", category: "worksheet", mappedTemplate: "Final analytical review Section 5100" },
        { section: "Subsequent Events (CAS 560)", category: "checklist", mappedTemplate: "Subsequent events Section 5100" },
        { section: "Going Concern — Final Assessment (CAS 570)", category: "checklist", mappedTemplate: "Going concern final Section 5100" },
        { section: "Management Representation Letter (CAS 580)", category: "letter", mappedTemplate: "Management representation Section 5100" },
        { section: "Communication with Those Charged with Governance (CAS 260)", category: "letter", mappedTemplate: "TCWG final communication Section 5100" },
        { section: "Completion Checklist (CAS 220)", category: "checklist", mappedTemplate: "Final completion Section 5100" },
        { section: "ASPE Disclosure Checklist", category: "checklist", mappedTemplate: "ASPE – General disclosure checklist" },
        { section: "Engagement Quality Control Review — EQCR (CSQC 1)", category: "checklist", mappedTemplate: "EQCR checklist Section 5100" },
        { section: "Signoffs", category: "module", mappedTemplate: "Automated" },
        { section: "Final Review", category: "module", mappedTemplate: "Automated" },
  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        ...
        { section: "E — Deferred Contributions (ASNPO s.4210)", category: "worksheet", mappedTemplate: "Deferred contributions Section 5101" },
  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        ...
        { section: "Inherent Risk & Risk of Material Misstatement (SAS 145)", category: "worksheet", mappedTemplate: "RMM worksheet Section 6100" },
        { section: "Fraud Risk Assessment (AU-C 240 / SAS 122)", category: "checklist", mappedTemplate: "Fraud risk Section 6100" },
        { section: "Journal Entry Testing (AU-C 240)", category: "worksheet", mappedTemplate: "Journal entry testing Section 6100" },
    ...
    },
    {
      ...
      rows: [
        { section: "Trial Balance & Adjusting Entries", category: "module", mappedTemplate: "Automated" },
        { section: "Proposed Audit Adjustments & Reclassifications (AU-C 450)", category: "worksheet", mappedTemplate: "AJE worksheet Section 6100" },
      ],
    },
    {
      name: "Procedures",
    ...
    },
    {
      ...
      rows: [
        ...
        { section: "Communication with Those Charged with Governance (AU-C 260 / 265)", category: "letter", mappedTemplate: "TCWG communication Section 6100" },
...
const audit6200: TemplateView = {
  ...
  sections: [
    ...
    },
    {
      name: "Risk Assessment",
      rows: [
        { section: "ICFR Scoping — Significant Accounts & Disclosures (AS 2201)", category: "worksheet", mappedTemplate: "ICFR scoping Section 6200" },
    ...
    },
    {
      ...
      rows: [
        ...
        { section: "Overall Substantive Response (AS 2301)", category: "checklist", mappedTemplate: "Overall response PCAOB Section 6200" },
        { section: "Substantive Analytical Procedures", category: "worksheet", mappedTemplate: "SAP PCAOB Section 6200" },
        { section: "Audit Procedures Summary", category: "module", mappedTemplate: "Automated" },
      ],
    },
    {
      name: "Documents",
      rows: [
        { section: "Shareholder / Board Resolutions & Minutes", category: "folder", mappedTemplate: "No Selection required" },
        { section: "Debt Agreements & Loan Covenants", category: "folder", mappedTemplate: "No Selection required" },
        { section: "SEC Filings (10-K, 10-Q, 8-K)", category: "folder", mappedTemplate: "No Selection required" },
        { section: "Material Contracts & Agreements", category: "folder", mappedTemplate: "No Selection required" },
        { section: "Lease Agreements (ASC 842)", category: "folder", mappedTemplate: "No Selection required" },
        { section: "Audit Committee Documentation", category: "folder", mappedTemplate: "No Selection required" },
      ],
    },
    {
      name: "Trial Balance & Adjusting Entries",
      rows: [
        { section: "Trial Balance & Adjusting Entries", category: "module", mappedTemplate: "Automated" },
        { section: "Proposed Audit Adjustments & Reclassifications (AS 2810)", category: "worksheet", mappedTemplate: "AJE PCAOB Section 6200" },
      ],
    },
    {
      name: "Procedures",
