...
const IntegrationBadge = ({
  ...
  if (type === "quickbooks") {
    return <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#2CA01C]/10 text-[#2CA01C] text-xs font-medium">
        <img src="https://cdn.worldvectorlogo.com/logos/quickbooks-1.svg" alt="QuickBooks" className="w-4 h-4" />
        QuickBooks
      </div>;
  }
  return null;
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col" style={{
            ...
            <div className="px-5 py-4 flex items-center justify-between flex-shrink-0 bg-white">
              ...
              <div className="relative">
                ...
                <Input placeholder="Search Engagement" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-9 w-56 h-9 text-sm border-0 focus:ring-1 focus:ring-primary/30" style={{ backgroundColor: "#FAFBFC", boxShadow: "0 1px 2px 0 rgb(0 0 0 / .15)" }} />
              </div>
            </div>
