          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="group flex items-center gap-1.5 px-2 py-1 rounded-md border border-muted-foreground/30 hover:bg-primary/5 transition-colors">
        ...
        <div className="sticky top-0 z-10 bg-card px-4 py-2 border-b border-border/50">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <ExpandableIconButton variant="outline" className="bg-card hover:bg-muted" <ExpandableIconButton variant="outline" className="bg-card hover:bg-muted" icon={<Network className="h-4 w-4" fill="currentColor" />} label="Auto Map" /> />
